    ...
    return (
        ...
        >
            <div>
                ...
                <input type="text" id="note-title" name="note-title" className="w-full p-2 mt-1 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-300 focus:border-blue-300" required />
            </div>
            <div>
                <label htmlFor="note-content" className="block font-medium text-gray-700">Content:</label>
                <textarea id="note-content" name="note-content" rows={6} className="w-full p-2 mt-1 border border-gray-300 rounded-md resize-none focus:outline-none focus:ring focus:ring-blue-300 focus:border-blue-300" />
            </div>
